...
| S34 | 2026-09-21 | websearch + fetch | **Pokémon casino games** (design research) | Gen 1–3 **Game Corner Slots** (3 reels, symbols 7/Poké Ball/Pikachu/Staryu/Cherries; 777=300 coins, balls=50; bet 1–3 coins = 1–5 paylines; HGSS bonus mode on 777). **Mauville Roulette** (RSE): 12 slots = 4 Pokémon × 3 colors, bet slot/color/Pokémon, payout 12/empty (×3–×12). **Card Flip** (GS Goldenrod): pick cards, bet on winner. Also: Voltorb Flip (HGSS), Pokéstar Studios (BW), PokeSino (modern fan slot game). → **DECISION: Poké Casino minigames** (Slots + Roulette + Card Flip) per user |
| S35 | 2026-09-21 | kenney.nl + shell + vision | **Casino assets**: Kenney Boardgame Pack (583 files: 52 cards + backs, 6 chip colors + sides + stacks, dice 1–6 red/white, dominoes) + Kenney Casino Audio (58 SFX: chip-lay/collide/stack/handle, dice throw/shake, card shuffle/slide/place) + 4 official Poké Ball item arts (poke/great/ultra/master) | → `prod/kenney/boardgame-pack/`, `prod/audio/casino-audio/`, `prod/items/*-ball.png`. Vision-verified (`preview_casino.html`): chips/cards/dice clean + consistent; slot symbols all official Pokémon art ✓ |
